PROC IMPORT OUT= WORK.princ 
            DATAFILE= "M:\03.02 Analysis\Delivery\MA_VISTA_Principal_Descriptive_Statistics.xlsx" 
            DBMS=EXCEL REPLACE;
...
PROC EXPORT DATA= WORK.table1 
            OUTFILE= "M:\04 Reports\2017 Reports\Comprehensive Reports\Principal\data for appendix.xlsx" 
            DBMS=EXCEL REPLACE;
     SHEET="table1"; 
RUN;
